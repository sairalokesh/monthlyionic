...
/**
 * Generated class for the AddmonthlytransactionPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-addmonthlytransaction',
  templateUrl: 'addmonthlytransaction.html',
})
export class AddmonthlytransactionPage  implements  OnInit {
    ...
    this.mapsAPILoader.load().then(() => {
      ...
      autocomplete.addListener("place_changed", () => {
        this.ngZone.run(() => {
          ...
          this.zoom = 25;
          this.getlocation(this.latitude,this.longitude,place.name,place.icon);
  ...
  getlocation(latitude,longitude,loctionName,icon){
